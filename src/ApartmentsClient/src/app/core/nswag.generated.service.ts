...
export class ApartmentUserService {
    ...
    getAllApartmentByOwnerId(): Observable<ApartmentDTO[]> {
        let url_ = this.baseUrl + "/api/apartments/owner/id";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAllApartmentByOwnerId(response: HttpResponseBase): Observable<ApartmentDTO[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(ApartmentDTO.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status === 400) {
...
export class CommentUserService {
    ...
    getAllCommentsByAuthorId(): Observable<CommentDTO[]> {
    ...
    protected processGetAllCommentsByAuthorId(response: HttpResponseBase): Observable<CommentDTO[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    getAllCommentsByApartmentId(apartmentId: string | null): Observable<CommentDTO[]> {
        let url_ = this.baseUrl + "/api/comments/apartment/{apartmentId}";
        if (apartmentId === undefined || apartmentId === null)
            throw new Error("The parameter 'apartmentId' must be defined.");
        url_ = url_.replace("{apartmentId}", encodeURIComponent("" + apartmentId)); 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAllCommentsByApartmentId(response: HttpResponseBase): Observable<CommentDTO[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class OrderUserService {
    ...
    getAllOrdersByCustomerId(): Observable<OrderView[]> {
    ...
    protected processGetAllOrdersByCustomerId(response: HttpResponseBase): Observable<OrderView[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    getAllOrdersByApartmentId(apartmentId: string | null): Observable<OrderDTO[]> {
        let url_ = this.baseUrl + "/api/orders/apartment/{apartmentId}";
        if (apartmentId === undefined || apartmentId === null)
            throw new Error("The parameter 'apartmentId' must be defined.");
        url_ = url_.replace("{apartmentId}", encodeURIComponent("" + apartmentId)); 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAllOrdersByApartmentId(response: HttpResponseBase): Observable<OrderDTO[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ApartmentSearchDTO[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<ApartmentSearchDTO[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetAllApartments(response: HttpResponseBase): Observable<ApartmentSearchDTO[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(ApartmentSearchDTO.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status === 400) {
        ...
        return _observableOf<ApartmentSearchDTO[]>(<any>null);
    }
...
export class CommentAdministrationService {
    ...
    getAllCommentsByUserId(userId: string | null): Observable<CommentDTOAdministration[]> {
        let url_ = this.baseUrl + "/api/administration/comments/user/{userId}";
    ...
    protected processGetAllCommentsByUserId(response: HttpResponseBase): Observable<CommentDTOAdministration[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(CommentDTOAdministration.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status === 400) {
    ...
    getAllCommentsByApartmentId(apartmentId: string | null): Observable<CommentDTOAdministration[]> {
        let url_ = this.baseUrl + "/api/administration/comments/apartment/{apartmentId}";
        if (apartmentId === undefined || apartmentId === null)
            throw new Error("The parameter 'apartmentId' must be defined.");
        url_ = url_.replace("{apartmentId}", encodeURIComponent("" + apartmentId)); 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAllCommentsByApartmentId(response: HttpResponseBase): Observable<CommentDTOAdministration[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class UserAdministrationService {
    ...
    getUserById(id: string | null): Observable<ResultOfUserAdministrationView> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ResultOfUserAdministrationView>><any>_observableThrow(e);
                }
            } else
                return <Observable<ResultOfUserAdministrationView>><any>_observableThrow(response_);
        }));
    }

    protected processGetUserById(response: HttpResponseBase): Observable<ResultOfUserAdministrationView> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ResultOfUserAdministrationView.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ResultOfUserAdministrationView>(<any>null);
    }
    ...
    changeRoleToAdmin(id: string | null): Observable<ResultOfUserAdministrationView> {
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processChangeRoleToAdmin(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processChangeRoleToAdmin(<any>response_);
                } catch (e) {
                    return <Observable<ResultOfUserAdministrationView>><any>_observableThrow(e);
                }
            } else
    ...
    protected processChangeRoleToAdmin(response: HttpResponseBase): Observable<ResultOfUserAdministrationView> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    changeRoleToUser(id: string | null): Observable<ResultOfUserAdministrationView> {
        let url_ = this.baseUrl + "/api/administration/users/roles/remove/admin/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processChangeRoleToUser(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processChangeRoleToUser(<any>response_);
                } catch (e) {
                    return <Observable<ResultOfUserAdministrationView>><any>_observableThrow(e);
                }
            } else
    ...
    protected processChangeRoleToUser(response: HttpResponseBase): Observable<ResultOfUserAdministrationView> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class ResultOfUserAdministrationView extends Result implements IResultOfUserAdministrationView {
    data?: UserAdministrationView | undefined;

    constructor(data?: IResultOfUserAdministrationView) {
        super(data);
    }
    ...
    init(_data?: any) {
        super.init(_data);
        if (_data) {
            this.data = _data["data"] ? UserAdministrationView.fromJS(_data["data"]) : <any>undefined;
        }
    }

    static fromJS(data: any): ResultOfUserAdministrationView {
        data = typeof data === 'object' ? data : {};
        let result = new ResultOfUserAdministrationView();
        result.init(data);
        return result;
    }
...
export interface IResultOfUserAdministrationView extends IResult {
    data?: UserAdministrationView | undefined;
}
