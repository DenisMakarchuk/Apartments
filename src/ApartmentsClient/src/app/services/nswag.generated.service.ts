...
export class ApartmentImageService {
    ...
    uploadImage(image: File | null | undefined, apartmentId: string | null | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/apartment-image/upload?";
    ...
    getImage(apartmentId: string | null, imageName: string | null): Observable<string> {
        let url_ = this.baseUrl + "/api/apartment-image/image/{apartmentId}/{imageName}";
    ...
    getImageNamesList(apartmentId: string | null): Observable<string[]> {
        let url_ = this.baseUrl + "/api/apartment-image/{apartmentId}";
        if (apartmentId === undefined || apartmentId === null)
            throw new Error("The parameter 'apartmentId' must be defined.");
        url_ = url_.replace("{apartmentId}", encodeURIComponent("" + apartmentId)); 
        url_ = url_.replace(/[?&]$/, "");
    ...
    delete(apartmentId: string | null, imageName: string | null): Observable<void> {
        let url_ = this.baseUrl + "/api/apartment-image/image/{apartmentId}/{imageName}";
        if (apartmentId === undefined || apartmentId === null)
            throw new Error("The parameter 'apartmentId' must be defined.");
        url_ = url_.replace("{apartmentId}", encodeURIComponent("" + apartmentId)); 
...
export class OrderUserService {
    ...
    formationOrder(order: AddOrder): Observable<OrderDTO> {
        let url_ = this.baseUrl + "/api/orders/formation";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFormationOrder(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFormationOrder(<any>response_);
                } catch (e) {
    ...
    protected processFormationOrder(response: HttpResponseBase): Observable<OrderDTO> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class UserService {
    ...
    register(request: UserRegistrationRequest): Observable<void> {
    ...
    forgotPassword(request: ForgotPasswordModel): Observable<void> {
...
export class ForgotPasswordModel implements IForgotPasswordModel {
    callBackUrl!: string;
    logInNameOrEmail!: string | undefined;

    constructor(data?: IForgotPasswordModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.callBackUrl = _data["callBackUrl"];
            this.logInNameOrEmail = _data["logInNameOrEmail"];
        }
    }

    static fromJS(data: any): ForgotPasswordModel {
        data = typeof data === 'object' ? data : {};
        let result = new ForgotPasswordModel();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["callBackUrl"] = this.callBackUrl;
        data["logInNameOrEmail"] = this.logInNameOrEmail;
        return data; 
    }
}
